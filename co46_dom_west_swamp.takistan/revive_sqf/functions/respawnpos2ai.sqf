...
_ll = str(leader (group _name)) + "_a";
if (missionNamespace getVariable _ll) then {waitUntil {!(missionNamespace getVariable _ll)}};
...
_base_2_distance =  _pos_leader distance MRR1;
_base_3_distance =  _pos_leader distance MRR2;
