...
class SAT_Satellitenbild {
	...
	movingEnable = true;
	controlsBackground[]={};
	onLoad="uiNamespace setVariable ['SAT_Satellitenbild', _this select 0];d_satcam_dialog_open = true";
	onUnLoad="uiNamespace setVariable ['SAT_Satellitenbild', nil];d_satcam_dialog_open = false";
	class controls {
		class Text1 {
			idc = -1;
			type = 0;
