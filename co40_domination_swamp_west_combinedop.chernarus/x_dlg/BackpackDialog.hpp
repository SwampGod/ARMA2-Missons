...
class GVAR(BackpackDialog) {
	idd = -1;
	movingEnable = 1;
	onLoad = "uiNamespace setVariable ['D_BACKPACK_DIALOG', _this select 0];d_backpack_dialog_open = true;call d_fnc_fillbackpacks";
	onUnLoad = "uiNamespace setVariable ['D_BACKPACK_DIALOG', nil];d_backpack_dialog_open = false";
	objects[] = {};
