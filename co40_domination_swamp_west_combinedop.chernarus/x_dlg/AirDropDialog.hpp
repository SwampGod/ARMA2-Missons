...
class XD_AirDropDialog {
	idd = -1;
	movingEnable = true;
	onLoad = "uiNamespace setVariable ['D_DROP_DIALOG', _this select 0];d_airdrop_dialog_open = true";
	onUnLoad = "uiNamespace setVariable ['D_DROP_DIALOG', nil];d_airdrop_dialog_open = false";
	objects[] = {};
