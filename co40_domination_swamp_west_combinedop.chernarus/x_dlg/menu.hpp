class TeleportModule {
	...
	movingEnable = false;
	objects[] = {};
	onLoad="uiNamespace setVariable ['X_TELE_DIALOG', _this select 0];d_teleport_dialog_open = true;0 spawn d_fnc_x_teleupdate_dlg";
	onUnLoad="uiNamespace setVariable ['X_TELE_DIALOG', nil];d_teleport_dialog_open = false";
