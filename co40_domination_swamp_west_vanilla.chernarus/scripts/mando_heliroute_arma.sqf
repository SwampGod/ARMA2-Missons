#define THIS_FILE "mando_heliroute_arma.sqf"
#include "x_setup.sqf"
/*********************************
...
private ["_heli","_route","_endpos","_height","_pilot","_pos","_dist","_distold","_angh","_dir","_speed","_steps","_inipos","_ang","_landing"];

PARAMS_4(_heli,_route,_height,_landing);
...
if (_landing) then {
	...
	while {alive _pilot && damage _heli < 0.5 && (GV(_heli,mando_heliroute)) == "waiting"} do {
		_pilot action ["ENGINEOFF", _heli];
		sleep 0.01;
	};
} else {
