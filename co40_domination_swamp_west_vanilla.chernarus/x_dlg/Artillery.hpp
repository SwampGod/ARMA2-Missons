class XD_ArtilleryDialog {
	idd = -1;
	movingEnable = true;
	onLoad = "uiNamespace setVariable ['D_ARTI_DISP', _this select 0];call d_fnc_initArtyDlg;d_arti_dialog_open = true";
	onUnLoad = "uiNamespace setVariable ['D_ARTI_DISP', nil];d_arti_dialog_open = false";
	objects[] = {};
