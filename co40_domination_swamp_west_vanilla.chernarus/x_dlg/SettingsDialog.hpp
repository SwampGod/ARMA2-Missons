class XD_SettingsDialog {
	idd = -1;
	movingEnable = 1;
	onLoad = "uiNamespace setVariable ['X_SETTINGS_DIALOG', _this select 0];d_settings_dialog_open = true";
	onUnLoad = "uiNamespace setVariable ['X_SETTINGS_DIALOG', nil];d_settings_dialog_open = false";
	objects[] = {};
