class XD_VecDialog {
	idd = -1;
	movingEnable = 1;
	onLoad = "uiNamespace setVariable ['X_VEC_DIALOG', _this select 0];d_vec_dialog_open = true";
	onUnLoad = "uiNamespace setVariable ['X_VEC_DIALOG', nil];d_vec_dialog_open = false";
	objects[] = {};
