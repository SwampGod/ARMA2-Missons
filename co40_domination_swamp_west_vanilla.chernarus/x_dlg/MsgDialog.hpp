class XD_MsgDialog {
	...
	movingEnable = 1;
	objects[] = {};
	onLoad="uiNamespace setVariable ['XD_MsgDialog', _this select 0];d_message_dialog_open = true";
	onUnLoad="uiNamespace setVariable ['XD_MsgDialog', nil];d_message_dialog_open = false";
