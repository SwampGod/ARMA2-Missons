 ...
 */
R3F_REV_CFG_list_of_classnames_who_can_revive = ["CAManBase","CACharacters_BAF","cacharacters2","cacharacters_e","GER_Soldier_EP1","GER_Soldier_MG_EP1","GER_Soldier_Medic_EP1","GER_Soldier_Scout_EP1","BAF_Soldier_EN_MTP","BAF_ASoldier_MTP","BAF_Soldier_GL_MTP","BAF_Soldier_EN_MTP","GER_Soldier_TL_EP1"];
