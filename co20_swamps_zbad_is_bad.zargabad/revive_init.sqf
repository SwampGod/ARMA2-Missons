...
_follow_cam_distance			= 10;				//array no.32 - the range that unconscious players can spectate friendly units
...
_top_view_height 	   			= 5;				//array no.55 - allows you to set the top down camera height 
